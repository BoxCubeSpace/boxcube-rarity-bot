...
const jsonrank = require("../../projectjson/vexedapesclub.json");
...
module.exports.run = async (Client, message, args, prefix) => {
  ...
  if (found[0] != undefined) {
    const Boxcube = new discord.MessageEmbed()
      ...
      .setURL(
        `https://paras.id/token/vexedapesclub.near::${found[0].token_series_id}/${found[0].token_series_id}`
      )
...
module.exports.help = {
  name: `vexedapesclub-rank`,
  aliases: ["vexedapes-rank"],
};
