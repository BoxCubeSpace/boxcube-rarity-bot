...
const jsonrank = require("../../projectjson/dragonnation.json");
...
module.exports.run = async (Client, message, args, prefix) => {
  ...
  if (found[0] != undefined) {
    const Boxcube = new discord.MessageEmbed()
      ...
      .setURL(
        `https://paras.id/token/dragonnation.near::${found[0].token_series_id}/${found[0].token_series_id}`
      )
...
module.exports.help = {
  name: `dragonnation-rank`,
  aliases: ["dragonn-rank"],
};
