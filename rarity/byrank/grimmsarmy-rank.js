...
const jsonrank = require("../../projectjson/grimmsarmy.json");
...
module.exports.run = async (Client, message, args, prefix) => {
  ...
  if (found[0] != undefined) {
    const Boxcube = new discord.MessageEmbed()
      ...
      .setURL(
        `https://paras.id/token/grimms.secretskelliessociety.near::${found[0].token_series_id}/${found[0].token_series_id}`
      )
