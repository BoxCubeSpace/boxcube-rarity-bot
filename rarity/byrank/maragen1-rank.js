  ...
  if (found[0] != undefined) {
    if (found[0].metadata.attributes[2] != undefined) {
      ...
      🎯 **TOTAL SCORE** ・ ***${found[0].total_rarity_score}***`
        ...
        .setFooter(
          "Made by Boxcube.",
          "https://firebasestorage.googleapis.com/v0/b/mint-pass-01.appspot.com/o/Boxcube%2FPic%20Boxcube 0 or !bxcb 0uBot.png?alt=media&token=97db6bb1-be8d-4316-bb57-4ad8d8e01833"
        );
